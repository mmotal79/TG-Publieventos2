...
const Login: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      // 1. Autenticar con Google PRIMERO (evita bloqueo de popups del navegador)
      ...
      if (res.ok) {
        ...
        if (data.estado === 'Activo') {
          ...
          await logout();
          setError(`Acceso denegado. Su cuenta se encuentra: ${data.estado}.`);
        }
      } else {
        await logout();
